"""
Django settings for DjangoControl project.
...
SECRET_KEY = 'django-insecure-(k4)v1gwipie+tw&t#v!9uuen5=-8-mir%t4gk4%_#qu4=h+#1'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=10060),
