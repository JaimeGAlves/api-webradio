...
from sponsors.serializers import PatrocinadorSerializer
...
#         sponsors = Sponsor.objects.all()
#         return render(request, 'sponsors/sponsors.html', {'form': form, 'sponsors': sponsors})
